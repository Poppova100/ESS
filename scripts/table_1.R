...
PROB <- readRDS("./data/prob_27.rds")

DTA_HW_PROB <- readRDS("./data/dta_prob_27.rds")
DTA_HW_PETP <- readRDS("./data/dta_PETP_27.rds")
DTA_HW_TG <- readRDS("./data/dta_TG_27.rds")
DTA_HW_P <- readRDS("./data/dta_P_27.rds")
...
x <- data.table(CT2=c('A', 'AN', 'ANE', 'AE', 'ASE', 'AS', 'ASW', 'AW', 'ANW', 'C', 'CN', 'CNE', 'CE', 'CSE', 'CS', 'CSW', 'CW', 'CNW', 'N', 'NE', 'E', 'SE', 'S', 'SW', 'W', 'NW', 'U'))
...
tab_HWH<-join(tab_HWH, PROB, by=c('CT'))
...
tab_HWL<-join(tab_HWL, PROB, by=c('CT'))
...
tab_HWO<-join(tab_HWO, PROB, by=c('CT'))
...
tab_HWG<-join(tab_HWG, PROB, by=c('CT'))
...
###
#write.table(HW_TAB, file="./data/table_27.txt")
